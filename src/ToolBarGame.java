...
public class ToolBarGame extends Application
{
    ...
    @Override public void start(Stage primaryStage)
    {
        ...
        Image imageDecline = new Image(getClass().getResourceAsStream("/toolbar/file.png"));
        btnNew.setGraphic(new ImageView(imageDecline));
        btnNew.setStyle("-fx-background-color: transparent, -fx-inner-border, transparent;");
